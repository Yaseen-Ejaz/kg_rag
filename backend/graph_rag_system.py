...
"""
    ...
    def apoc_subgraph(self, start_node_name, max_depth=10, max_nodes=1000):
    ...
    def generate_answer_from_bfs(self, question, context):
        ...
        prompt = f"""
            ...
            - Be explicit about which nodes/relationships led to the answer (put them in square brackets [])
    ...
    # ================= Main pipeline =================
    def ask(self, question, max_depth=7, max_nodes_per_entity=1000):
        print(f"\n{'='*60}")
